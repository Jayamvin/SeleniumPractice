...
//		}
		...
		List<String> countryList = new ArrayList<String>(Arrays.asList("India", "Brazil","Aruba", "Bahamas"));
		System.out.println(getDropDownOptions(country)); //this gives all countries list 
		
		// syntax for containsAll is List.containsAll(List)
		if(getDropDownOptions(country).containsAll(countryList)) {
			System.out.println("India,Brazil -- PASS");	
