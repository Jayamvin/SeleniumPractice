...
//				.click();
		...
		// a[text()='Joe.Root']/parent::td/preceding-sibling::td/input[@type='checkbox'] --- LeftHandSide

		// a[text()='John.Smith']/parent::td/preceding-sibling::td/input[@type='checkbox']----LeftHandSide
		
		// (//a[text()='Joe.Root']/parent::td/following-sibling::td)[3]---RightHandSide
	...
	//these methods for specific page 
	// Left hand side
